...
int VenceuJogador(tJogador jogador, tTabuleiro tabuleiro){
    if(jogador.id == ID_JOGADOR_1){
        ...
        if(EstaMarcadaPosicaoPecaTabuleiro(tabuleiro, 0, 0, tabuleiro.peca1) && EstaMarcadaPosicaoPecaTabuleiro(tabuleiro, 1, 1, tabuleiro.peca1) && EstaMarcadaPosicaoPecaTabuleiro(tabuleiro, 2, 2, tabuleiro.peca1)){
            return 1;
        }else if(EstaMarcadaPosicaoPecaTabuleiro(tabuleiro, 2, 0, tabuleiro.peca1) && EstaMarcadaPosicaoPecaTabuleiro(tabuleiro, 1, 1, tabuleiro.peca1) && EstaMarcadaPosicaoPecaTabuleiro(tabuleiro, 0, 2, tabuleiro.peca1)){
            return 1;
        }
    }else{
        for(int i=0; i<TAM_TABULEIRO; i++){
        ...
        if(EstaMarcadaPosicaoPecaTabuleiro(tabuleiro, 0, 0, tabuleiro.peca2) && EstaMarcadaPosicaoPecaTabuleiro(tabuleiro, 1, 1, tabuleiro.peca2) && EstaMarcadaPosicaoPecaTabuleiro(tabuleiro, 2, 2, tabuleiro.peca2)){
            return 1;
        }else if(EstaMarcadaPosicaoPecaTabuleiro(tabuleiro, 2, 0, tabuleiro.peca2) && EstaMarcadaPosicaoPecaTabuleiro(tabuleiro, 1, 1, tabuleiro.peca2) && EstaMarcadaPosicaoPecaTabuleiro(tabuleiro, 0, 2, tabuleiro.peca2)){
            return 1;
        }
    }
